...
class DataArguments:
    ...
    high_res_size: int = field(default=1536)
    force_high_res_canvas: bool = field(default=False)
...
class ModelArguments:
    ...
    # LogRetina pos embed configs
    # N: "none"       — zero global spatial PE (scale embeddings retained)
    # A: "learned"    — original learnable grid (default, backward compat)
    # B: "linear"     — Linear(2 → C)
    # C: "fourier"    — Fourier features, no log warp
    # D: "log_retina" + pos_embed_dynamic_center=False
    # E: "log_retina" + pos_embed_dynamic_center=True
    pos_embed_type: str = field(default="learned")
    pos_embed_alpha: float = field(default=5.0)
    pos_embed_num_freqs: int = field(default=32)
    pos_embed_dynamic_center: bool = field(default=True)
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    reinit_pos_embed: bool = field(default=False)
    zero_init_pos_embed: bool = field(default=False)
    ...
    # store
    quick_store: bool = field(default=False)
