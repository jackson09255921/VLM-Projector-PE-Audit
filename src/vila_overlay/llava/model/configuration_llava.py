...
class LlavaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        # pos_embed_type: which positional embedding to use
        #   "learned"    → Ablation A: original learnable grid (default, backward compat)
        #   "linear"     → Ablation B: Linear(2 → C), no Fourier, no log warp
        #   "fourier"    → Ablation C: Fourier features, no log warp, fixed center
        #   "log_retina" → Ablation D/E: log(1+r) warp + Fourier
        #                  D: pos_embed_dynamic_center=False (fixed center)
        #                  E: pos_embed_dynamic_center=True  (PS3 selection centroid)
        pos_embed_type="learned",
        pos_embed_alpha=5.0,
        pos_embed_num_freqs=32,
        pos_embed_dynamic_center=True,
        ### End of PS3 configs ###
        ...
        **kwargs,
        ...
        self.pos_embed_alpha = pos_embed_alpha
        self.pos_embed_num_freqs = pos_embed_num_freqs
        self.pos_embed_dynamic_center = pos_embed_dynamic_center
